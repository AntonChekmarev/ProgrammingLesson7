...
int taskCount = 1; // кол-во задач текущего семинара (от 1 до 9). надеюсь более 9 задач не будет =)

string MenuItemName(int taskNamber) // наименования пунктов меню
{
    switch (taskNamber)
    {
        case 1: return "Задача HARD SORT"; // Task1.cs
        case 2: return "Задача № "; // Task2.cs
        case 3: return "Задача № "; // Task3.cs
